...
#calculate user's remaing days using formula assume person will die at age 90
#remaining days =  (90- age )*365
r_days = (90 - age)*365
print("you have  {}  days".format(r_days))

#calculate user's remaining week using formula assume every year has 52 weeks
